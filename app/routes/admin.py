...
GENERAL_DEFAULTS = {
    ...
    "track_points_independent": False,
...
def config_general():
    ...
    current["GENERAL"] = {
        ...
        "auto_assign_guards":          bool(request.form.get("auto_assign_guards")),
        "guard_assign_mode":           assign_mode,
        "track_points_independent":    bool(request.form.get("track_points_independent")),
